  ...
  <div id="at-modal" data-visible="true">
    ...
    <div id="at-footer">
      <div class="at-button-row">
        ...
        <button id="at-copy-button" class="at-btn" title="Copy to Clipboard">Copy</button>
        <button id="at-preview-button" class="at-btn" title="Preview Prompt">Preview</button>
      ...
      <div id="at-total-estimate">Est. Tokens: 0</div>
    </div>
  </div>
  <div id="at-toast-container"></div>
`;